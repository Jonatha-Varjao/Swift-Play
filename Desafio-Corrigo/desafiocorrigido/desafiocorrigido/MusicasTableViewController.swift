...
class MusicasTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        self.musicas = MusicasDAO.getLista()
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if let animalCell = cell as? MusicasTableViewCell
        {
            let musicas = self.musicas[indexPath.row]
            animalCell.MusicaLabel.text = musicas.nomeMusica
            animalCell.artistaLabel.text = musicas.nomeArtista
        }
     ...
     */
     ...
     // Pass the selected object to the new view controller.
        if segue.identifier == "mostrarDetails"
        {
            if let novaView = segue.destination as? DetailsViewController
            {
                let musica = musicas[(tableView.indexPathForSelectedRow?.row)!]
                novaView.musicas = musica
            }
        }
    }
